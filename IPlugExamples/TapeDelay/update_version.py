...
def main():
  ...
  plistpath = scriptpath + "/resources/TapeDelay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TapeDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TapeDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TapeDelay-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TapeDelay-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TapeDelay-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/TapeDelay-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/TapeDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TapeDelay.iss",inplace=1):

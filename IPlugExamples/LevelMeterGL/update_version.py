...
def main():
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LevelMeterGL-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/LevelMeterGL-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/LevelMeterGL.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LevelMeterGL.iss",inplace=1):

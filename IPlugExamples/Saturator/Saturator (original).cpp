...
void Saturator::ProcessDoubleReplacing(double** inputs, double** outputs, int nFrames)
{
...
void Saturator::OnParamChange(int paramIdx)
{
  IMutexLock lock(this);
...
double Saturator::fastAtan(double x){

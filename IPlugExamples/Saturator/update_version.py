...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Michael, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Saturator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Saturator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Saturator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Saturator-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Saturator-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Saturator-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Saturator-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Saturator.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Saturator.iss",inplace=1):

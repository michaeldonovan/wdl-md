...
def main():
  ...
  plistpath = scriptpath + "/resources/Reverb-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Reverb-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Reverb-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Reverb-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Reverb-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Reverb-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Reverb-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Reverb.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Reverb.iss",inplace=1):

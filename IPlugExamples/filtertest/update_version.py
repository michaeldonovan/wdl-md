...
def main():
  ...
  plistpath = scriptpath + "/resources/filtertest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/filtertest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/filtertest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/filtertest-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/filtertest-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/filtertest-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/filtertest-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/filtertest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/filtertest.iss",inplace=1):
